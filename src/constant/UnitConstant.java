...
public class UnitConstant {
        ...
        static final public Image NORMAL_UNIT_IMAGE_URL_1 = new Image(StringUtil.getImageUrl("normal-unit-1.png"));
        static final public Image NORMAL_UNIT_IMAGE_URL_2 = new Image(StringUtil.getImageUrl("normal-unit-2.png"));
        ...
        static final public Image FLYING_UNIT_IMAGE_URL_1 = new Image(StringUtil.getImageUrl("flying-unit.jpg"));
        static final public Image FLYING_UNIT_IMAGE_URL_2 = new Image(StringUtil.getImageUrl("flying-unit.jpg"));
        ...
        static final public Image SHOOTER_UNIT_IMAGE_URL_1 = new Image(StringUtil.getImageUrl("shooter-unit.png"));
        static final public Image SHOOTER_UNIT_IMAGE_URL_2 = new Image(StringUtil.getImageUrl("shooter-unit.png"));
        ...
        static final public Image VENOM_UNIT_IMAGE_URL_1 = new Image(StringUtil.getImageUrl("venom-unit.jpg"));
        static final public Image VENOM_UNIT_IMAGE_URL_2 = new Image(StringUtil.getImageUrl("venom-unit.jpg"));
        ...
        static final public Image HEALER_UNIT_IMAGE_URL_1 = new Image(StringUtil.getImageUrl("healer-unit.png"));
        static final public Image HEALER_UNIT_IMAGE_URL_2 = new Image(StringUtil.getImageUrl("healer-unit.png"));
        ...
        static final public Image FREEZER_UNIT_IMAGE_URL_1 = new Image(StringUtil.getImageUrl("freezer-unit.jpeg"));
        static final public Image FREEZER_UNIT_IMAGE_URL_2 = new Image(StringUtil.getImageUrl("freezer-unit.jpeg"));
